    ...
    <h1 style="font-size: 20px; color: #A1FF9F;">Finder</h1>
        <div class="hierarki">
            <p style="font-size: 20px; color: white; margin-left: 55px;">Hierarki 
                <a href="beranda.php" style="margin-top: 10px;">Beranda</a>
                <a href="php/aktivitas.php">Aktivitas</a>
                <a href="php/referensi.php">Referensi</a>
                <!-- <a href="info_mitra.php">Info Mitra</a> -->
            </p>
            <p style="font-size: 20px; color: white; margin-left: 150px;">Bantuan
                <a href="php/bantuan.html" style="margin-top: 10px;">Apa saja layanan yang disediakan?</a>
                <a href="php/bantuan.html">Siapa target penggunanya?</a>
                <a href="php/bantuan.html">Bagaimana sistem ini bekerja?</a>
                <a href="php/bantuan.html">Bagaimana cara daftar lapangan?</a>
                <a href="cpanel-admin-arenafinder/startbootstrap-sb-admin-2-gh-pages/login.php">Masuk aplikasi?</a>
                <a href="cpanel-admin-arenafinder/startbootstrap-sb-admin-2-gh-pages/register.php">Daftar aplikasi?</a>
            </p>
